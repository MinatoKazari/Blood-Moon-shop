...
<head>
    ...
    <%request.setCharacterEncoding("GBK"); String keyword = request.getParameter("keyword");%>
...
<div id="tabs1">
    <h2 style="position: relative;left: 19%;width: 1000px;">关键词搜索：<%=request.getParameter("keyword")%></h2>
    <a style="position: relative;left: 19%;text-decoration: none;color: darkcyan;font-size: 18px;" href="indexsearchPricesUp.jsp?keyword=<%=request.getParameter("keyword")%>">价格从低到高展示</a>
    <a style="position: relative;left: 20%;text-decoration: none;color: darkcyan;font-size: 18px;" href="indexsearchPricesDown.jsp?keyword=<%=request.getParameter("keyword")%>">价格从高到低展示</a>
    <center>
            ...
            <tr>
                <td>
                    <%
                        ...
                        System.out.println("搜索接收keyword："+request.getParameter("keyword"));
                        ItemDao itemDao = new ItemDao();
                        ArrayList<Item> list = itemDao.getSearchItemPricesDown(String.valueOf(request.getParameter("keyword")));
