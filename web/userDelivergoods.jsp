...
<div id="tabs1">
    <a style="position: absolute;top: -50px;left: 355px;font-size: 30px;">等待发货的订单</a>
    <center>
            ...
            <tr>
                <td>
                    <%
                        ...
                        ArrayList<Order> list = orderDao.getUserDelivergoodOrder(Integer.parseInt(session.getAttribute("uid").toString()));
                    ...
                    <div id="order">
                        <dl>
                            ...
                            <dd style="position: relative;font-size:22px;font-weight: 400;max-width: 780px;">物流信息：<%=order.getUgodealinfo()%></dd>
                            <dd><a target = "_blank" href="usercontactway3.jsp?uid=<%=order.getUgoUidb()%>"><input type="button" class="btn" value="查看买家联系方式"></a></dd>
                            <dd><a href="Delivergoods.jsp?ugoid=<%=order.getUgoid()%>"><input type="button" class="btn2" value="发货"></a></dd>
                        </dl>
                    </div>
                    <%
                            }
