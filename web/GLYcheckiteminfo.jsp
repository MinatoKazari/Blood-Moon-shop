...
<div id="item_win">
    ...
    <div id="sco">
            ...
            <input type="button" value="不通过" class="btn1" id="btn1" onclick="notpass()">
            <input type="button" value="通过" class="btn2" id="btn2" onclick="pass()">
        <SCRIPT>
            function pass() {
                if(confirm('确定要通过该商品？')) {
                    window.location.href = 'PassitemServlet?sid=<%=item.getSid()%>';//GLYdelitem.jsp
                }
            }
            function notpass() {
                window.location.href='GLYnotpassitem2.jsp?sid=<%=item.getSid()%>';//GLYnotpassitem.jsp-->notpassitem.jsp
            }
        </SCRIPT>
    </div>
</div>
