        ...
        <div id="login">
            ...
            <span>
                    <form action="login" method="post">
                        <p class="form"><input type="text" name="username" placeholder="用户名"></p>
                        <p class="form"><input type="password" name="password" placeholder="密码"></p>
                        <input type="submit" value="登录" class="btn" style="margin-right: 20px;">
                        <input type="button" value="注册" class="btn" onclick="signin()" id="btn">
                    </form>
                    <a href="foundpwd.jsp" style="width: 100px;text-decoration: none;color: #fff;display: block;position: relative;left:8%;">忘记密码？</a>
                    <a href="loginGLY.jsp"style="width: 100px;text-decoration: none;color: #fff;display: block;position: relative;top:-104px;left: 60%;">管理员登录</a>
                </span>
        </div>
