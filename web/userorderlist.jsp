...
<div id="tabs1">
    <a style="position: absolute;top: -50px;left: 355px;font-size: 30px;">用户的购买记录</a>
    <center>
            ...
            <tr>
                <td>
                    <%
                        ...
                        ArrayList<Order> list = orderDao.getUserOrder(Integer.parseInt(session.getAttribute("uid").toString()));
                    ...
                    <div id="order">
                        <dl>
                            ...
                            <dd><a href="usercontactway.jsp?uid=<%=order.getUgoUids()%>"><input type="button" class="btn" value="查看卖家联系方式"></a></dd>
